...
rclcpp::Publisher<sensor_msgs::msg::Image>::SharedPtr pub_aligned_img;
...
void img_callback(const sensor_msgs::msg::Image::SharedPtr img_msg)
{
    ...
    {
        auto aligned_msg = ptr->toImageMsg();
        aligned_msg->header = img_msg->header;
        pub_aligned_img->publish(*aligned_msg);
    }
...
int main(int argc, char **argv)
{
    ...
    pub_aligned_img = n->create_publisher<sensor_msgs::msg::Image>("/aligned_grayscale_image", 1000);
    /*
    if (SHOW_TRACK)
